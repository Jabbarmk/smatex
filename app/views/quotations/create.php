                ...
                <form action="<?= BASE_URL ?>quotations/store" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="quotation_no" class="form-control fw-bold border-0 bg-light" value="<?= $quotation_no ?>" readonly>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="text-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4"><i class="fas fa-paper-plane"></i> Create Quotation</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            btn.onclick = function() {
                if(document.querySelectorAll('.item-row').length > 1) {
                    this.closest('.item-row').remove();
                     ...
                     // If want to support removing all, need logic to add back. 
                     // For now keep at least one
                }
                calcTotal();
            };
        });
